...
- **Shop bling on the shareable card (#42).** Your equipped custom title, badge frame **and profile theme** now show on all three card skins and on the friends-drawer card, under the same privacy toggles as the equipped badges.
