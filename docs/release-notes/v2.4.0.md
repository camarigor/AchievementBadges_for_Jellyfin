...
- **And the profile theme.** The first thing TsunamicFlame named was "Pastel", and #119 had left the theme out. The equipped theme now paints the shareable card on all three skins (backdrop, surfaces and accent; Metro keeps its fixed 360 green tiles and takes the backdrop) and colours the accent of the friends-drawer card. Fourteen themes, each with the gradient the achievements page uses for it. Same privacy gate as the title and the frame.
